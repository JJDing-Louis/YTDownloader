...
internal class DatabaseInitializer : IAppInitializer
{
    ...
    private void EnsureSystemTables(string connectionString)
    {
        ...
        using (var conn = ConnectionTool.GetConnection())
        {
            foreach (var sql in commands) conn.Execute(sql);
        }
    ...
    private void EnsureTEnitiyData(string connectionString)
    {
        ...
        var commands = new[]
        {
            SQLTEntityData_ListSourceType, SQLTEntityData_ListMediaType, SQLTEntityData_ListDownloadStatus,
            SQLTEntityData_DownloadHistory
        };
    ...
    private readonly string InitTEntity = """
    ...
    private readonly string InitTEntity_Columns = """
    ...
    private readonly string InitTEntity_Mvt = """
    ...
    private readonly string InitTEntityDisplayType = """
    ...
    private readonly string InitTSQL_LOG = """
