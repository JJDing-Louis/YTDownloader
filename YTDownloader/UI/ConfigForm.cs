...
namespace YTDownloader.UI
{
    public partial class ConfigForm : Form
    {
        ...
        private void BuildGeneralPanel()
        {
            ...
            fields.Controls.Add(new Label { Text = "顯示語言", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 0);
        ...
        private GroupBox CreateAppearanceGroup()
        {
            ...
            layout.Controls.Add(new Label { Text = "背景顏色", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 1);
            layout.Controls.Add(_backColorTextBox, 1, 1);
            layout.Controls.Add(colorButton, 2, 1);
            layout.Controls.Add(new Label { Text = "顏色預覽", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 2);
            layout.Controls.Add(_backColorPreview, 1, 2);
            layout.Controls.Add(new Label { Text = "背景圖片", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 3);
        ...
        private GroupBox CreateFontGroup()
        {
            ...
            layout.Controls.Add(new Label { Text = "字型", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 0);
            layout.Controls.Add(_fontComboBox, 1, 0);
            layout.Controls.Add(new Label { Text = "字型大小", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 1);
        ...
        private void BuildThreadPanel()
        {
            ...
            fields.Controls.Add(new Label { Text = "初始數量", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 0);
            fields.Controls.Add(_initialThreadNumeric, 1, 0);
            fields.Controls.Add(new Label { Text = "最大數量", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 1);
        ...
        private void BuildSavePanel()
        {
            ...
            fields.Controls.Add(new Label { Text = "下載資料夾", TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill }, 0, 0);
        ...
        private void LoadSettings()
        {
            ...
            _fontSizeNumeric.Value = Clamp(_settings.Appearance.FontSize, _fontSizeNumeric.Minimum, _fontSizeNumeric.Maximum);

            _initialThreadNumeric.Value = Clamp(_settings.Thread.InitialCount, _initialThreadNumeric.Minimum, _initialThreadNumeric.Maximum);
            _maxThreadNumeric.Value = Clamp(_settings.Thread.MaxCount, _maxThreadNumeric.Minimum, _maxThreadNumeric.Maximum);
